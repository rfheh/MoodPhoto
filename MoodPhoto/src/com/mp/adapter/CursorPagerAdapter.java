...
public abstract class CursorPagerAdapter extends PagerAdapter {
     ...
     */
	public static final int FLAG_REGISTER_CONENT_OBSERVER = 0x02;
	...
	public CursorPagerAdapter(Context context, Cursor c, boolean autoRequery) {
		init(context, c, autoRequery ? FLAG_AUTO_REQUERY : FLAG_REGISTER_CONENT_OBSERVER);
	}
	...
	void init(Context context, Cursor c, int flags) {
		if ((flags & FLAG_AUTO_REQUERY) == FLAG_AUTO_REQUERY) {
			flags |= FLAG_REGISTER_CONENT_OBSERVER;
			mAutoRequery = true;
		} else {
			mAutoRequery = false;
		}
		...
		if ((flags & FLAG_REGISTER_CONENT_OBSERVER) == FLAG_REGISTER_CONENT_OBSERVER) {
